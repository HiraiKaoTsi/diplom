...
class CreateUser(QtWidgets.QFrame):
    def __init__(self, id_user, fio, number_group, student_id_number, open_info_user, number_phone=None, email=None, vk=None, telegram=None):
        super().__init__()
        ...
        if email or vk or telegram is not None: 
            # Frame button 
            frame_button = QtWidgets.QFrame(self)
            frame_button.setMinimumSize(QtCore.QSize(151, 41))
            ...
            gridLayout.addWidget(frame_button, 3, 1, 1, 2)


            # Layout for frame button
        ...
        pushButton_all_info.clicked.connect(lambda: open_info_user(id_user))
